...
public class EmployeeManagementSystems {
...
class MainMenu {
    public void menu() {
        ...
        System.out.println("\t\t\t************************");
        System.out.println("\t\t\t  ~$Berat Demirak");
        System.out.println("\t\t\t --------------");
        ...
        try {
            ...
            if (f1.createNewFile()) {
                ...
                myWriter.write("Employee ID:" + emp.employeeID + "\n" +
                        ...
                        "Employee Father's Name: " + emp.fatherName + "\n" +
...
class Employee_Update
{
    ...
    public void out() {
        System.out.println("\n******************");
        System.out.println("$ cat Thank You For Using my Sofware");
        System.out.println("****************");
        System.out.println("\t\t/~ <03d by Berat Demirak\n");
        System.exit(0);
       }
    }


/***********  Coded By Berat Demirak **********/
